...
parser.add_argument("--trip-name",           default=None)
...
if args.trip_name:           cmd += ["--trip-name",   args.trip_name]
if args.client_name:         cmd += ["--client-name", args.client_name]
if args.agency_name:         cmd += ["--agency-name", args.agency_name]
